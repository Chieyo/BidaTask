...
class Onboarding5Screen extends StatefulWidget {
  ...
  @override
  State<Onboarding5Screen> createState() => _Onboarding5Screen();
}

class _Onboarding5Screen extends State<Onboarding5Screen> {
  @override
        ...
        child: Stack(
          children: [
            ...
            Positioned(
              ...
              child: Center(
                child: Image.asset(
                  'assets/images/onboarding5_graphic.png',
                  width: 356,
                  height: 356,
                ),
              ),
            ...
            Positioned(
              ...
              child: Center(
                child: Image.asset(
                  'assets/images/page-control5.png',
                  width: 82,
                  height: 8,
                ),
              ),

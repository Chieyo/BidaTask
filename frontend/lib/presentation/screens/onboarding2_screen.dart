...
class Onboarding2Screen extends StatefulWidget {
  ...
  @override
  State<Onboarding2Screen> createState() => _Onboarding2Screen();
}

class _Onboarding2Screen extends State<Onboarding2Screen> {
  @override
        ...
        child: Stack(
          children: [
            ...
            Positioned(
              ...
              child: Center(
                child: Image.asset(
                  'assets/images/onboarding2_graphic.png',
                  width: 356,
                  height: 356,
                ),
              ),
            ...
            Positioned(
              ...
              child: const Center(
                child: SizedBox(
                  width: 303,
                  child: Text(
                    'Share your task, match with locals, and see it finished in no time.',
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      fontSize: 16,
            ...
            Positioned(
              ...
              child: Center(
                child: Image.asset(
                  'assets/images/page-control2.png',
                  width: 82,
                  height: 8,
                ),
              ),
